...
import { runTimingRecognitionForLesson } from "../../../../../../../server/modules/listening/listening.timingWorker";
...
export async function POST(
  ...
  try {
    ...
    return NextResponse.json(await runTimingRecognitionForLesson(lessonId, admin.email));
  } catch (error) {
